...
class _HomeScreenState extends State<HomeScreen> {
  List<GlobalMenuModel> menuItem = [
    GlobalMenuModel(img: Images.doctorInc, text: 'Library Site'),
    GlobalMenuModel(img: Images.doctorInc, text: 'Book Search'),
    GlobalMenuModel(img: Images.doctorInc, text: 'e-Theses Search'),
    GlobalMenuModel(img: Images.doctorInc, text: 'Online Books'),
    GlobalMenuModel(img: Images.doctorInc, text: 'University Site'),
  ];
