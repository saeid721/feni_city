...
class _DoctorScreenState extends State<DoctorScreen> {
  ...
  //
  List<GlobalMenuModel> menuItem = [
    GlobalMenuModel(img: Images.medicineSpecialist, text: 'মেডিসিন'),
    ...
    GlobalMenuModel(img: Images.aesthetician, text: 'এস্থেটিশিয়ান'),
    ...
    GlobalMenuModel(img: Images.psychologist, text: 'সাইকোলজিস্ট'),
    ...
    GlobalMenuModel(img: Images.pathologist, text: 'প্যাথলজিস্ট'),
    GlobalMenuModel(img: Images.dentist, text: 'ডেন্টিস্ট'),
    GlobalMenuModel(img: Images.geriatrician, text: 'জেরিয়াট্রিশিয়ান'),
    GlobalMenuModel(img: Images.physiotherapist, text: 'ফিজিয়োথেরাপিস্ট'),
    ...
    GlobalMenuModel(img: Images.criticalCareSpecialist, text: 'ক্রিটিকাল কেয়ার স্পেশালিস্ট'),
    GlobalMenuModel(img: Images.publicHealthSpecialist, text: 'পাবলিক হেলথ স্পেশালিস্ট'),
    GlobalMenuModel(img: Images.emergencyMedicineSpecialist, text: 'ইমার্জেন্সি মেডিসিন স্পেশালিস্ট'),
    GlobalMenuModel(img: Images.preventiveMedicineSpecialist, text: 'প্রিভেন্টিভ মেডিসিন স্পেশালিস্ট'),
    GlobalMenuModel(img: Images.infectiousDiseaseSpecialist, text: 'ইনফেকশিয়াস ডিজিজ স্পেশালিস্ট'),
    GlobalMenuModel(img: Images.sportsMedicineSpecialist, text: 'স্পোর্টস মেডিসিন স্পেশালিস্ট'),
    GlobalMenuModel(img: Images.painManagementSpecialist, text: 'পেইন ম্যানেজমেন্ট স্পেশালিস্ট'),
    GlobalMenuModel(img: Images.palliativeCareSpecialist, text: 'প্যালিয়েটিভ কেয়ার স্পেশালিস্ট'),
    ...
    GlobalMenuModel(img: Images.homeopathy, text: 'হোমিওপ্যাথি'),
  ];
  int currentIndex = 0;
